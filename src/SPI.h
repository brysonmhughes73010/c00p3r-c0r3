...
// SPI_HAS_TRANSFER_ASYNC - Defined to indicate that the SPI library supports asynchronous
// transfer methods. This allows non-blocking SPI data transfers using DMA (Direct Memory Access)
// and event responders. It is useful for applications that require high-speed data transfers
// without CPU intervention, improving overall system performance.
...
/**
 * @class SPISettings
 * @brief This class encapsulates the settings for SPI communication.
 *
 * The SPISettings class is used to configure the SPI clock speed, bit order, and data mode.
 * It provides constructors to initialize these settings and methods to apply them.
 * 
 * Example usage:
 * @code
...
/**
 * @class SPISettings
 * @brief This class encapsulates the settings for SPI communication on Teensy 3.x.
 *
 * The SPISettings class is used to configure the SPI clock speed, bit order, and data mode.
 * It provides constructors to initialize these settings and methods to apply them.
 * 
...
/**
 * @class SPISettings
 * @brief This class encapsulates the settings for SPI communication on Teensy-LC.
 *
 * The SPISettings class is used to configure the SPI clock speed, bit order, and data mode.
 * It provides constructors to initialize these settings and methods to apply them.
 * 
...
/**
 * @class SPISettings
 * @brief This class encapsulates the settings for SPI communication on Teensy 4.x.
 *
 * The SPISettings class is used to configure the SPI clock speed, bit order, and data mode.
 * It provides constructors to initialize these settings and methods to apply them.
 * 
...
/**
 * @class SPIClass
 * @brief This class provides an interface for SPI communication on various Arduino boards.
 * 
 * The SPIClass class allows for SPI communication, supporting various settings, transactions,
 * and transfer methods. It includes methods for initializing the SPI bus, setting SPI settings,
 * transferring data, and handling interrupts. The class is designed to work with different
 * microcontroller architectures, including AVR, Teensy 3.x, Teensy-LC, and Teensy 4.x.
 * 
 * Example usage:
 * @code
 * SPI.begin();
...
/**
 * @class SPIClass
 * @brief This class provides an interface for SPI communication on Teensy 3.x boards.
 * 
 * The SPIClass class allows for SPI communication, supporting various settings, transactions,
 * and transfer methods. It includes methods for initializing the SPI bus, setting SPI settings,
 * transferring data, and handling interrupts. The class is designed to work with different
 * microcontroller architectures, including Teensy 3.x.
 * 
 * Example usage:
 * @code
 * SPI.begin();
...
/**
 * @class SPIClass
 * @brief This class provides an interface for SPI communication on Teensy-LC boards.
 * 
 * The SPIClass class allows for SPI communication, supporting various settings, transactions,
 * and transfer methods. It includes methods for initializing the SPI bus, setting SPI settings,
 * transferring data, and handling interrupts. The class is designed to work with different
 * microcontroller architectures, including Teensy-LC.
 * 
 * Example usage:
 * @code
 * SPI.begin();
...
/**
 * @class SPIClass
 * @brief This class provides an interface for SPI communication on Teensy 4.x boards.
 * 
 * The SPIClass class allows for SPI communication, supporting various settings, transactions,
 * and transfer methods. It includes methods for initializing the SPI bus, setting SPI settings,
 * transferring data, and handling interrupts. The class is designed to work with different
 * microcontroller architectures, including Teensy 4.x.
 * 
 * Example usage:
 * @code
 * SPI.begin();
...
//	}
	...
	void transfer16(const void * buf, void * retbuf, size_t count) {
		const uint16_t *txbuf = (const uint16_t *)buf;
		uint16_t *rxbuf = (uint16_t *)retbuf;
		for (size_t i = 0; i < count; i++) {
			rxbuf[i] = transfer16(txbuf[i]);
		}
	}
...
/**
 * @brief External declaration of an SPIClass object named SPI.
 * 
 * This object is used to interface with the SPI (Serial Peripheral Interface) hardware.
 * It provides methods to configure and communicate with SPI devices.
 * 
 * Example usage:
 * @code
 * SPI.begin();
